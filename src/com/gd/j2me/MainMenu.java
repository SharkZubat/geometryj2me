...
public class MainMenu extends GameCanvas implements Runnable {
	...
	private int groundSpeed = 180;
	//colours
	private float hue = 0f;        
	private float hueSpeed = 0.15f; 
    ...
    public void update() {
        ...
        // scroll ground
        groundX -= (int)(groundSpeed * deltaTimeSeconds);
        ...
        rainbowColor = hsvToRgb(hue, 1f, 1f);
        //
    ...
    public void draw() {
        ...
        //draw ground
        g.drawImage(ground, groundX, groundY, Graphics.TOP | Graphics.LEFT);
        g.drawImage(ground, groundX + ground.getWidth(), groundY, Graphics.TOP | Graphics.LEFT);
        g.drawImage(ground, groundX + 2*ground.getWidth(), groundY, Graphics.TOP | Graphics.LEFT);
        g.drawImage(ground, groundX + 3*ground.getWidth(), groundY, Graphics.TOP | Graphics.LEFT);
        g.drawImage(ground, groundX + 4*ground.getWidth(), groundY, Graphics.TOP | Graphics.LEFT);
        g.drawImage(ground, groundX + 5*ground.getWidth(), groundY, Graphics.TOP | Graphics.LEFT);
        flushGraphics();
    }
    ...
    public void drawmainlevels() {
        ...
        g.setColor(0x287DFF);
        g.fillRect(0, 0, getWidth(), getHeight());
        CustomFont.drawString(bigFontbig, 0, 0, 1f, "Test Level", 22, g);
